...
In multi-label image classification, current approaches often focus on basic geometric relationships or localized features, neglecting cross-scale contextual interactions between objects. 
